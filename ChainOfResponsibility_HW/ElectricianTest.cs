...
{
    internal class ElectricianTest : CheckClassAbs
    {
        public override void HandleCar(Car car)
        {
            ...
            if (test >= 6)
            {
                Console.WriteLine($"{car.Model} You passed the Electrician Test test successfully , You are transferred to the next test");
                if (nextCheck != null)
